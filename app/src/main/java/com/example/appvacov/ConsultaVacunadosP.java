...
public class ConsultaVacunadosP extends AppCompatActivity {
    private TextView cedula_personal_que_vacuno;
    List<ListElement2> elements2;
    RequestQueue rq;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_consulta_vacunados_p);
    ...
    private void consultar(String URL){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URL, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                ListAdapter2 listAdapter2 = new ListAdapter2(elements2,ConsultaVacunadosP.this);
                RecyclerView recyclerView = findViewById(R.id.recyclerView3);
                recyclerView.setHasFixedSize(true);
                recyclerView.setLayoutManager(new LinearLayoutManager(ConsultaVacunadosP.this));
